var Application = {
   initApplication: function() {
      ...
      $(document).on(
         ...
         {
            //if (properties.options.data != undefined){
   ...
   updateMediaList: function() {
      window.requestFileSystem(
         ...
         0,
         function(fileSystem){
            var root = fileSystem.root.fullPath + '/media/';
            AppFile.deleteFiles();
   ...
   createFilesList: function(idElement, files)
   {
      ...
      {
         $('#' + idElement).append("<br><p>No file has been added to the music library.</p>");         
         $('#' + idElement).append("<p>To update your music library files, please, hit the 'Update' button in the right upper corner of the application.</p>");
         return;
      }
